    ...
    return (
      <div className="container-slider mt-1">
        ...
        <div className="banner-container mt-4">
          ...
          <button type="button" className="btn btn-warning me-3" onClick={jumpHandlerMenu}>Order Now</button> 
          <button type="button" className="btn btn-outline-light" onClick={jumpHandlerReservation}>Book A Table</button>
        </div>
